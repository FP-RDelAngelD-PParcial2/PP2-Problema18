...
public class PP2Problema18 {
    ...
    public static void minimoComunD(int a, int b, int c){
        ...
        if(b<a && c<a){ //Se necesita conocer el numero menor para saber en cuanto se puede dividir //8>4>6
            numeromaximo=a; //Si a es mayor que b, b es el numero menor //FALSO
        }else if(a<b && c<b){
            numeromaximo=b; //Sino el numero menor es a //numeromenor=8
        }else{
            numeromaximo=c;
        }
        while(numeromaximo>=divisor){ //Mientras que el numero menor sea mayor o igual al divisor, //8>=2 VERDADERO
        ...
        //Se imprime el minimo comun multiplo //
